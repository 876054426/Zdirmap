...
#用户输入部分
def userinput():
    parser = argparse.ArgumentParser(description="zydx")             #argparse模块的作用是用于解析命令行参数，然后创建一个解析对象parser
    ...
    parser.add_argument("-r","--report",action="store_true",help="Save The Result to html")
